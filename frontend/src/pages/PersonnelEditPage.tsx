  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader
        ...
        description={`${query.data?.nom.toUpperCase()} ${query.data?.prenoms}`}
      />
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate>
        <Card>
          <CardContent className="grid gap-4 p-6 sm:grid-cols-2 lg:grid-cols-3">
            <div className="space-y-1.5"><Label>Matricule de recrutement *</Label><Input {...register('matriculeRecrutement')} />{errors.matriculeRecrutement && <p className="text-xs text-destructive">{errors.matriculeRecrutement.message}</p>}</div>
            ...
            <div className="space-y-1.5"><Label>Date de naissance *</Label><Input type="date" {...register('dateNaissance')} /></div>
